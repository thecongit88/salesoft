    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          _summaryTitle(Icons.history_sharp, "Chi tiết giao dịch từ ${controller.getDateString(controller.periodReportSelected!.timeValue.fromDate)} đến ${controller.getDateString(controller.periodReportSelected!.timeValue.toDate)}"),
